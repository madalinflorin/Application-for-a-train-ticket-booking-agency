...
public class ViewInsert1 extends JFrame {
	
	private static String[] limba = {"ID bilet","Nume calator","Prenume calator","Numar telefon","E-mail","CNP","ID tren","Operatii CRUD"};
	private static String titlu = "Operatii CRUD";
	
	private JLabel l1 = new JLabel("ID bilet");
	private JLabel l2 = new JLabel("Nume calator");
	private JLabel l3 = new JLabel("Prenume calator");
	private JLabel l4 = new JLabel("Numar telefon");
	private JLabel l5 = new JLabel("E-mail");
	private JLabel l6 = new JLabel("CNP");
	private JLabel l7 = new JLabel("ID tren");
	...
	public ViewInsert1() {
		...
		JPanel p81 = new JPanel(new FlowLayout(FlowLayout.LEFT));
