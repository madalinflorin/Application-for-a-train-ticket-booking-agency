...
public class ViewUpdateA extends JFrame {
	
	private static String[] limba = {"Nume","Prenume","Nr.tel","CNP","Parola","Salariu","Program de lucru","Administrator","Operatii CRUD"};
